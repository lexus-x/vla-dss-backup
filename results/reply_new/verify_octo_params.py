...
print(f"VLA-DSS (LIBERO)            : 28.9M  (incl. 0.40M learned text encoder; 7.03M trainable)")
print(f"VLA-DSS FINAL PRODUCT       : ~32.9M (with 4.4M bert-tiny text encoder for real-world)")
print(f"=> deployable size ratio    : {(lang+other)/28.9e6:.1f}x (LIBERO) / {(lang+other)/32.9e6:.1f}x (product)")
